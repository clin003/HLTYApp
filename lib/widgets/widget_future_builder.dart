...
import 'package:app/widgets/widget_net_error.dart';
...
//              LogUtil.e("<CustomFutureBuilder>连接状态：${snapshot.connectionState}");
              switch (snapshot.connectionState) {
                ...
                // print("连接数据状态：${snapshot.error}");
//                LogUtil.e("<CustomFutureBuilder>连接数据状态：${snapshot.error}");
//                LogUtil.e("<CustomFutureBuilder>连接数据状态(data)：${snapshot.data}");
//                LogUtil.e("<CustomFutureBuilder>连接数据状态(data)：${snapshot}");
                  if (snapshot.hasData) {
